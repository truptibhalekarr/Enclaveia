...
{{
  ...
  "conclusion": "2-sentence executive conclusion on what action to take next."
        ...
        # --- TERMINAL HACKER LOGS (BEFORE AI CALL) ---
        print("\n" + "="*50)
        print("🚀 ENCLAVEIA SECURE ENGINE INITIATED")
        print("🔒 Routing data to Local AI... (Zero Cloud Calls)")
        print("🧠 Activating Local Model: Gemma 2 (2B) via Ollama")
        print("⏳ Analyzing statistical profile and generating insights...")
        print("="*50 + "\n")

        raw = get_insight(prompt)

        # --- TERMINAL HACKER LOGS (AFTER AI CALL) ---
        print("\n✅ Insights Successfully Generated by Local Gemma 2!")
        print("📤 Sending encrypted payload back to Next.js Frontend.\n")
